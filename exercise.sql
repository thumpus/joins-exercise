-- 1. Join the two tables so that every column 
-- and record appears, regardless of if there 
-- is not an owner_id. Your output should look like this:
...
-- count of vehicles. The first_name should be ordered 
...
-- 3. Count the number of cars for each owner and display the 
-- average price for each of the cars as integers. Display the
--  owners first_name, last_name, average price and count of vehicles. 
--  The first_name should be ordered in descending order. Only display 
